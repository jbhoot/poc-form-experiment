...
module Action = {
  ...
  module WithDomEvent = {
    ...
    external toStateWithEffect: (('s, 'ev) => ('s, effect)) => action =
      "%identity";
    external toStateWithEffects2:
      (('s, 'ev) => ('s, effect, effect)) => action =
      "%identity";
    external toStateWithEffects3:
  ...
  module WithPayload = {
    ...
    external toStateWithEffect: ((('s, 'p) => ('s, effect), 'p)) => action =
      "%identity";
    external toStateWithEffects2:
      ((('s, 'p) => ('s, effect, effect), 'p)) => action =
      "%identity";
    external toStateWithEffects3:
...
module Effect = {
  ...
  external withPayload: (((dispatch, 'p) => unit, 'p)) => effect =
    "%identity";
...
module Subscription = {
  type nonrec cleanupFn = (. unit) => unit;
  external noPayload: (dispatch => cleanupFn) => subscription = "%identity";
  external withPayload: (((dispatch, 'p) => cleanupFn, 'p)) => subscription =
    "%identity";
};
...
module H = {
  type nonrec props;
  [@obj]
  external props: (~onchange: [@ns.namedArgLoc] action=?, unit) => props;
  [@module "hyperapp"] [@val]
  external t: (string, props, array(vnode)) => vnode = "h";
};
...
module P = {
  ...
  external t: (props, array(vnode)) => vnode = "p";
};
...
module Div = {
  ...
  external p:
    (
      ~id: [@ns.namedArgLoc] string=?,
      ~class_: [@ns.namedArgLoc] string=?,
      unit
    ) =>
    props;
  [@module "@hyperapp/html"] [@val]
  external t: (props, array(vnode)) => vnode = "div";
};
...
module Img = {
  ...
  external p:
    (
      ~src: [@ns.namedArgLoc] string,
      ~alt: [@ns.namedArgLoc] string,
      ~class_: [@ns.namedArgLoc] string=?,
      unit
    ) =>
    props;
...
module Main = {
  ...
  [@obj] external p: unit => props;
  [@module "@hyperapp/html"] [@val]
  external t: (props, array(vnode)) => vnode = "main";
};
...
module Span = {
  ...
  [@obj] external p: unit => props;
  [@module "@hyperapp/html"] [@val]
  external t: (props, array(vnode)) => vnode = "span";
};
...
module Label = {
  ...
  [@obj] external p: unit => props;
  [@module "@hyperapp/html"] [@val]
  external t: (props, array(vnode)) => vnode = "label";
};
...
module Button = {
  ...
  [@module "@hyperapp/html"] [@val]
  external t: (p, array(vnode)) => vnode = "button";
};
